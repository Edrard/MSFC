...
CREATE TABLE IF NOT EXISTS `col_players` (
  ...
  `globalmap_champion_spotted` int(8) NOT NULL,
  `globalmap_champion_hits` int(8) NOT NULL,
  `globalmap_champion_battle_avg_xp` int(8) NOT NULL,
  `globalmap_champion_draws` int(8) NOT NULL,
  `globalmap_champion_wins` int(8) NOT NULL,
  `globalmap_champion_losses` int(8) NOT NULL,
  `globalmap_champion_capture_points` int(8) NOT NULL,
  `globalmap_champion_battles` int(8) NOT NULL,
  `globalmap_champion_damage_dealt` int(8) NOT NULL,
  `globalmap_champion_hits_percents` int(8) NOT NULL,
  `globalmap_champion_damage_received` int(8) NOT NULL,
  `globalmap_champion_shots` int(8) NOT NULL,
  `globalmap_champion_xp` int(8) NOT NULL,
  `globalmap_champion_frags` int(8) NOT NULL,
  `globalmap_champion_survived_battles` int(8) NOT NULL,
  `globalmap_champion_dropped_capture_points` int(8) NOT NULL,
  
  `globalmap_middle_spotted` int(8) NOT NULL,
  `globalmap_middle_hits` int(8) NOT NULL,
  `globalmap_middle_battle_avg_xp` int(8) NOT NULL,
  `globalmap_middle_draws` int(8) NOT NULL,
  `globalmap_middle_wins` int(8) NOT NULL,
  `globalmap_middle_losses` int(8) NOT NULL,
  `globalmap_middle_capture_points` int(8) NOT NULL,
  `globalmap_middle_battles` int(8) NOT NULL,
  `globalmap_middle_damage_dealt` int(8) NOT NULL,
  `globalmap_middle_hits_percents` int(8) NOT NULL,
  `globalmap_middle_damage_received` int(8) NOT NULL,
  `globalmap_middle_shots` int(8) NOT NULL,
  `globalmap_middle_xp` int(8) NOT NULL,
  `globalmap_middle_frags` int(8) NOT NULL,
  `globalmap_middle_survived_battles` int(8) NOT NULL,
  `globalmap_middle_dropped_capture_points` int(8) NOT NULL,
  
  `globalmap_absolute_spotted` int(8) NOT NULL,
  `globalmap_absolute_hits` int(8) NOT NULL,
  `globalmap_absolute_battle_avg_xp` int(8) NOT NULL,
  `globalmap_absolute_draws` int(8) NOT NULL,
  `globalmap_absolute_wins` int(8) NOT NULL,
  `globalmap_absolute_losses` int(8) NOT NULL,
  `globalmap_absolute_capture_points` int(8) NOT NULL,
  `globalmap_absolute_battles` int(8) NOT NULL,
  `globalmap_absolute_damage_dealt` int(8) NOT NULL,
  `globalmap_absolute_hits_percents` int(8) NOT NULL,
  `globalmap_absolute_damage_received` int(8) NOT NULL,
  `globalmap_absolute_shots` int(8) NOT NULL,
  `globalmap_absolute_xp` int(8) NOT NULL,
  `globalmap_absolute_frags` int(8) NOT NULL,
  `globalmap_absolute_survived_battles` int(8) NOT NULL,
  `globalmap_absolute_dropped_capture_points` int(8) NOT NULL,
  ...
  `clan_dropped_capture_points` int(8) NOT NULL,
    ...
    `stronghold_defense_spotted` int(8) NOT NULL,
  `stronghold_defense_hits` int(8) NOT NULL,
  `stronghold_defense_battle_avg_xp` int(8) NOT NULL,
  `stronghold_defense_draws` int(8) NOT NULL,
  `stronghold_defense_wins` int(8) NOT NULL,
  `stronghold_defense_losses` int(8) NOT NULL,
  `stronghold_defense_capture_points` int(8) NOT NULL,
  `stronghold_defense_battles` int(8) NOT NULL,
  `stronghold_defense_damage_dealt` int(8) NOT NULL,
  `stronghold_defense_hits_percents` int(8) NOT NULL,
  `stronghold_defense_damage_received` int(8) NOT NULL,
  `stronghold_defense_shots` int(8) NOT NULL,
  `stronghold_defense_xp` int(8) NOT NULL,
  `stronghold_defense_frags` int(8) NOT NULL,
  `stronghold_defense_survived_battles` int(8) NOT NULL,
  `stronghold_defense_dropped_capture_points` int(8) NOT NULL,
  
    `stronghold_skirmish_spotted` int(8) NOT NULL,
  `stronghold_skirmish_hits` int(8) NOT NULL,
  `stronghold_skirmish_battle_avg_xp` int(8) NOT NULL,
  `stronghold_skirmish_draws` int(8) NOT NULL,
  `stronghold_skirmish_wins` int(8) NOT NULL,
  `stronghold_skirmish_losses` int(8) NOT NULL,
  `stronghold_skirmish_capture_points` int(8) NOT NULL,
  `stronghold_skirmish_battles` int(8) NOT NULL,
  `stronghold_skirmish_damage_dealt` int(8) NOT NULL,
  `stronghold_skirmish_hits_percents` int(8) NOT NULL,
  `stronghold_skirmish_damage_received` int(8) NOT NULL,
  `stronghold_skirmish_shots` int(8) NOT NULL,
  `stronghold_skirmish_xp` int(8) NOT NULL,
  `stronghold_skirmish_frags` int(8) NOT NULL,
  `stronghold_skirmish_survived_battles` int(8) NOT NULL,
  `stronghold_skirmish_dropped_capture_points` int(8) NOT NULL,
