...
CREATE TABLE IF NOT EXISTS `col_medals` (
  ...
  `up` int(12) NOT NULL,
  `medalCarius` int(11) NOT NULL DEFAULT 0,
  `medalHalonen` int(11) NOT NULL DEFAULT 0,
  `invader` int(11) NOT NULL DEFAULT 0,
  `medalFadin` int(11) NOT NULL DEFAULT 0,
  `armorPiercer` int(11) NOT NULL DEFAULT 0,
  `medalEkins` int(11) NOT NULL DEFAULT 0,
  `mousebane` int(11) NOT NULL DEFAULT 0,
  `medalKay` int(11) NOT NULL DEFAULT 0,
  `defender` int(11) NOT NULL DEFAULT 0,
  `medalLeClerc` int(11) NOT NULL DEFAULT 0,
  `supporter` int(11) NOT NULL DEFAULT 0,
  `steelwall` int(11) NOT NULL DEFAULT 0,
  `medalAbrams` int(11) NOT NULL DEFAULT 0,
  `medalPoppel` int(11) NOT NULL DEFAULT 0,
  `medalOrlik` int(11) NOT NULL DEFAULT 0,
  `handOfDeath` int(11) NOT NULL DEFAULT 0,
  `sniper` int(11) NOT NULL DEFAULT 0,
  `warrior` int(11) NOT NULL DEFAULT 0,
  `titleSniper` int(11) NOT NULL DEFAULT 0,
  `medalWittmann` int(11) NOT NULL DEFAULT 0,
  `medalBurda` int(11) NOT NULL DEFAULT 0,
  `scout` int(11) NOT NULL DEFAULT 0,
  `beasthunter` int(11) NOT NULL DEFAULT 0,
  `kamikaze` int(11) NOT NULL DEFAULT 0,
  `raider` int(11) NOT NULL DEFAULT 0,
  `medalOskin` int(11) NOT NULL DEFAULT 0,
  `medalBillotte` int(11) NOT NULL DEFAULT 0,
  `medalLavrinenko` int(11) NOT NULL DEFAULT 0,
  `medalKolobanov` int(11) NOT NULL DEFAULT 0,
  `invincible` int(11) NOT NULL DEFAULT 0,
  `lumberjack` int(11) NOT NULL DEFAULT 0,
  `tankExpert` int(11) NOT NULL DEFAULT 0,
  `diehard` int(11) NOT NULL DEFAULT 0,
  `medalKnispel` int(11) NOT NULL DEFAULT 0,
  `maxDiehardSeries` int(11) NOT NULL DEFAULT 0,
  `maxInvincibleSeries` int(11) NOT NULL DEFAULT 0,
  `maxPiercingSeries` int(11) NOT NULL DEFAULT 0,
  `maxKillingSeries` int(11) NOT NULL DEFAULT 0,
  `maxSniperSeries` int(11) NOT NULL DEFAULT 0,
  `medalBoelter` int(11) NOT NULL DEFAULT 0,
  `sinai` int(11) NOT NULL DEFAULT 0,
  `evileye` int(11) NOT NULL DEFAULT 0,
  `medalDeLanglade` int(11) NOT NULL DEFAULT 0,
  `medalTamadaYoshio` int(11) NOT NULL DEFAULT 0,
  `medalNikolas` int(11) NOT NULL DEFAULT 0,
  `medalLehvaslaiho` int(11) NOT NULL DEFAULT 0,
  `medalDumitru` int(11) NOT NULL DEFAULT 0,
  `medalPascucci` int(11) NOT NULL DEFAULT 0,
  `medalLafayettePool` int(11) NOT NULL DEFAULT 0,
  `medalRadleyWalters` int(11) NOT NULL DEFAULT 0,
  `medalTarczay` int(11) NOT NULL DEFAULT 0,
  `medalBrunoPietro` int(11) NOT NULL DEFAULT 0,
  `medalCrucialContribution` int(11) NOT NULL DEFAULT 0,
  `medalBrothersInArms` int(11) NOT NULL DEFAULT 0,
  `huntsman` int(11) NOT NULL DEFAULT 0,
  `luckyDevil` int(11) NOT NULL DEFAULT 0,
  `ironMan` int(11) NOT NULL DEFAULT 0,
  `sturdy` int(11) NOT NULL DEFAULT 0,
  `pattonValley` int(11) NOT NULL DEFAULT 0,
  `heroesOfRassenay` int(11) NOT NULL DEFAULT 0,
  `bombardier` int(11) NOT NULL DEFAULT 0,
  `mechanicEngineer` int(11) NOT NULL DEFAULT 0,
